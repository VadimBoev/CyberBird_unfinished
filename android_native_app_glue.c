...
#define LOGI(...) ((void)__android_log_print(ANDROID_LOG_INFO, "smallapp", __VA_ARGS__))
#define LOGE(...) ((void)__android_log_print(ANDROID_LOG_INFO, "smallapp", __VA_ARGS__))

/* For debug builds, always enable the debug traces in this library */

#ifndef NDEBUG
#  define LOGV(...)  ((void)__android_log_print(ANDROID_LOG_INFO, "smallapp", __VA_ARGS__))
#else
#  define LOGV(...)  ((void)0)
#endif
...
static void * debug_capture_thread_fn( void * v )
{
    ...
    while((readSize = read(pfd[0], buf, sizeof buf - 1)) > 0) {
        ...
        __android_log_write(ANDROID_LOG_DEBUG, "smallapp", buf); // Set any log level you want
#ifdef RDALOGFNCB
